...
public class BlogAdmin extends JFrame {
	...
	public BlogAdmin() {
		...
		this.setTitle("Blog");
		this.setIconImage((Toolkit.getDefaultToolkit().createImage(BlogAdmin.class.getResource("/Image/blog.png"))));
	...
	// Đoạn này phải có vòng lặp để thêm nhiều bài viết vào này
		...
		JLabel lblNewLabel_2 = new JLabel(new ImageIcon( new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(
						BlogAdmin.class.getResource("/Image/so_luot_thich_blog.png")
						)
